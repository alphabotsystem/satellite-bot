...
pub static CONFIGURATION: Map<&'static str, (&'static str, Option<&'static str>, &'static str)> = phf_map! {
	...
	// "799586549187870720" => ("Twelvedata", None, "ARBKF"),
	"799586605106331719" => ("Twelvedata", None, "ABML"),
	...
	// "978658892563247145" => ("Twelvedata", None, "PSFE"),
	"978658777349910628" => ("Twelvedata", None, "F"),
	"979840435633664130" => ("CCXT", Some("binance"), "MATICUSDT"),
	"979840523160408114" => ("CoinGecko", None, "SETH2USD"),
	"979840574859395132" => ("CoinGecko", None, "RETH2USD"),
